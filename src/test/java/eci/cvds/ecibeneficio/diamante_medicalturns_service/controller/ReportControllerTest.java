...
class ReportControllerTest {
    ...
    void testGetAverageLevelAttentionByRole() throws Exception {
        ...
        mockMvc
                .perform(get("/api/reports/avg-role")
    ...
    void testGetTurnCountByRole() throws Exception {
        ...
        when(turnService.getTurnCountByRole(eq(RoleEnum.ADMINISTRATOR), any(), any(), eq(StatusEnum.COMPLETED)))
                .thenReturn(List.of(countRole));

        mockMvc
                .perform(get("/api/reports/count-role")
    ...
    void testGetAverageLevelAttentionBySpeciality() throws Exception {
        AverageLevelBySpeciality avgSpeciality = new AverageLevelBySpecialityImpl(SpecialityEnum.DENTISTRY, 4.5);
        when(turnService.getAverageLevelAttentionBySpeciality(eq(SpecialityEnum.DENTISTRY), any(), any()))
                .thenReturn(List.of(avgSpeciality));

        mockMvc
                .perform(get("/api/reports/avg-speciality")
    ...
    void testGetTurnCountBySpeciality() throws Exception {
        ...
        when(turnService.getTurnCountBySpeciality(eq(SpecialityEnum.PSYCHOLOGY), any(), any(), eq(StatusEnum.PENDING)))
                .thenReturn(List.of(countSpeciality));

        mockMvc
                .perform(get("/api/reports/count-speciality")
